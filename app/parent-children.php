		...
		$pcConfig = [
			'assignments' => [
				'ProjectId' => [
					...
					'forced-where' => '',
					'display-fields' => [1 => 'Project', 3 => 'Resource', 4 => 'Commitment', 5 => 'Start Date', 6 => 'End Date'],
					'display-field-names' => [1 => 'ProjectId', 3 => 'ResourceId', 4 => 'Commitment', 5 => 'StartDate', 6 => 'EndDate'],
					'sortable-fields' => [0 => '`assignments`.`Id`', 1 => '`projects1`.`Name`', 2 => 3, 3 => '`resources1`.`Name`', 4 => '`assignments`.`Commitment`', 5 => '`assignments`.`StartDate`', 6 => '`assignments`.`EndDate`'],
					'records-per-page' => 10,
					'default-sort-by' => 6,
