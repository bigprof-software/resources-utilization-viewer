			...
			$schema = [
				'assignments' => [
					...
					'ResourceId' => [
						...
						'info' => [
							'caption' => 'Resource',
							'description' => 'Non-available resources are not listed in the drop-down.',
						],
					],
					'Commitment' => [
						'appgini' => "FLOAT(3,2) NOT NULL DEFAULT '1.00'",
						'info' => [
							'caption' => 'Commitment',
							'description' => '1.00 means full time commitment, 0.50 means half-time, ... etc.',
						],
					],
					'StartDate' => [
						'appgini' => "DATE NULL",
				...
				'resources' => [
					...
					'Available' => [
						'appgini' => "VARCHAR(40) NULL DEFAULT '1'",
						'info' => [
							'caption' => 'Available',
							'description' => '',
						],
